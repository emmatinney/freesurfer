...
########################     USAGE
sh run_heudiconv.sh R33rtsz999 localizer
...
# IN PATHS
main_proj='/work/cnelab/test/ADNIDOD/'
dicom_dir=${main_proj}'/0******/*/20*'
...
if [ ${subject} = help ]; then
  echo "$(tput setaf 1)USAGE: $(basename $0) <subject ID: R33rtszXXX> <session_name: localizer/nf1/nf2/nf3/nf4/nf5>"
  exit 1
fi
...
# ** UPDATE THIS PATH
#rm -r /home/rt/rtsz/data/.heudiconv/
echo "++++ FINISHED ++++"
